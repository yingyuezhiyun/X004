    ...
    public class PLDParams
    {
        ...
        public class SetParam
        {
            ...
            public class PulseParam
            {
                ...
                public List<float> Interval { get; set; } = new List<float>(11);
        ...
        private (object ParamsGet, object result) ParseFrame(PLDRev data)
        {
            ...
            switch ((DEV_GET_CMD_TYPE)data.cmd)
            {
                ...
                case DEV_GET_CMD_TYPE.WRK_STA:
                    ...
                    p.MeasureParams.Status = (UInt32)((data.data[0]<<16)| (data.data[1] << 8)|(data.data[2] << 0));
                    break;
                ...
                case DEV_GET_CMD_TYPE.ALL_M:
                    {
                        ...
                        p.MeasureParams.Status = data.data[38]|((UInt32)data.data[39]<<8)| ((UInt32)data.data[40] << 16);
                        p.MeasureParams.Version = "V"+ data.data[41]+"."+ data.data[42] + "."+ data.data[43] + "."+ data.data[44];
                        p.time = data.time;
                ...
                case DEV_GET_CMD_TYPE.M_LCM:
                    {
                        ...
                        p.MeasureParams.LCMParams.Power = data.data[7];
                    }                    
                    break;
