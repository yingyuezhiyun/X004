...
namespace wpfApp.Extensions
{
    public static class DialogExtensions
    {
        ...
        public static async Task<IDialogResult> Question(this IDialogHostService dialogHost,
            string title, string content, string dialogHostName = "Root", MsgType msgType = MsgType.YesNo
            )
        {
            ...
            param.Add("MsgType", msgType);
            //TODO 增加显示按钮
            var dialogResult = await dialogHost.MyShowDialog("MsgView", param, dialogHostName);
            return dialogResult;
        }
        ...
        public static void SendMessage(this IEventAggregator aggregator, string message, string filterName = "Main",
           double TimeSpan = 1, string Color = null, MessageModel.MessageType Type = MessageModel.MessageType.Default)
        {
