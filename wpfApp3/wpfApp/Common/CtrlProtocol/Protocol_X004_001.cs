...
using static wpfApp.Common.CtrlProtocol.PLDParams.MeasureParam;
    ...
    public class PLDParams
    {
        ...
        public class SetParam
        {
            ...
            public class TECParam
            {
                ...
                public float Curr { get; set; }
                public float Vol { get; set; }
                public short Mode { get; set; }//模式 未使用
                public float Power { get; set; }
                public float Temp { get; set; }
            ...
            public class PulseParam
            {
                ...
                public List<ushort> Interval { get; set; } = new List<ushort>(11);
            ...
            {
                public ushort CurrIdx { get; set; }
                public ushort TotalPaketNum { get; set; }
        ...
        public class LCMSetParams
        {
            ...
            public ushort MotorSpeed; // 转速 1rpm
